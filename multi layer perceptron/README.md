...
Esta pasta concentra os experimentos com `MLPClassifier` para classificacao das amostras de soja.

## Estrutura

- `scripts/`: scripts de treinamento e comparacao das redes MLP.
...
- `resultados/comparacoes/`: comparacao entre configuracoes da MLP.
