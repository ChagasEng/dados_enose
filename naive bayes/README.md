...
Esta pasta concentra os experimentos com classificadores Naive Bayes para classificacao das amostras de soja.

## Estrutura

- `scripts/`: scripts de treinamento e comparacao dos modelos Naive Bayes.
...
- `resultados/importancias/`: importancia por permutacao das features.
- `resultados/comparacoes/`: comparacao entre configuracoes do Naive Bayes.
